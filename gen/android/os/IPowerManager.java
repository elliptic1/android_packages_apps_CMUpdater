 ...
 * Original file: /media/7af6e9e4-35a3-cd01-40a6-e1e435a3cd01/android/system/frameworks/base/core/java/android/os/IPowerManager.aidl
 */
package android.os;
/** @hide */
...
static final int TRANSACTION_getLightSensorValue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getRawLightSensorValue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getLightSensorScreenBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getLightSensorButtonBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getLightSensorKeyboardBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_cpuBoost = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
}
// WARNING: changes in acquireWakeLock() signature must be reflected in IPowerManager.cpp/h
