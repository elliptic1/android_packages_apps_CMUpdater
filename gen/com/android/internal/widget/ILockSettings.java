 ...
 * Original file: /media/7af6e9e4-35a3-cd01-40a6-e1e435a3cd01/android/system/frameworks/base/core/java/com/android/internal/widget/ILockSettings.aidl
 */
...
int _arg2;
_arg2 = data.readInt();
this.setInteger(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
...
int _arg2;
_arg2 = data.readInt();
int _result = this.getInteger(_arg0, _arg1, _arg2);
reply.writeNoException();
...
public void setInteger(java.lang.String key, int value, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(userId);
mRemote.transact(Stub.TRANSACTION_setInteger, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
public int getInteger(java.lang.String key, int defaultValue, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
_data.writeInt(userId);
mRemote.transact(Stub.TRANSACTION_getInteger, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_setInteger = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_setString = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_getBoolean = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_getLong = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getInteger = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getString = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_setLockPattern = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_checkPattern = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setLockPassword = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_checkPassword = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
...
static final int TRANSACTION_removeUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
}
public void setBoolean(java.lang.String key, boolean value, int userId) throws android.os.RemoteException;
public void setLong(java.lang.String key, long value, int userId) throws android.os.RemoteException;
public void setInteger(java.lang.String key, int value, int userId) throws android.os.RemoteException;
